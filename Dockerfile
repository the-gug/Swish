...
RUN apt-get update && apt-get install -y curl build-essential debhelper devscripts pkg-config libssl-dev zip git libcurl4-openssl-dev musl-dev musl-tools cmake libclang-dev g++
